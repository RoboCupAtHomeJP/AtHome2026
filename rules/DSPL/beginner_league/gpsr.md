...
- ※ 「命令を理解できた」のみの点数を取ることを禁止とする．
  - 「命令を理解できた」の得点を得るためには，「コマンドxを成功」に対し何点かの得点があったことが条件である．
...
| --- | --- |
| 命令を理解できた | 80点×3回 |
| 命令を理解できた（カスタムオペレータ） | -20点×3回 |
| 命令を理解できた（speech recognitionを使用しない） | -50点×3回 |
| タスクプランを示す | 100点×3回 |
| コマンド | 　 |
| コマンドセットの命令を成功 | 250点x3回 |
| コマンドジェネレータの命令を成功 | 125点x3回 |

- ※各コマンドは，次の点数で部分点を付ける.
  - 1ヵ所以上適切な場所へ自律移動する 50点
  - 1人以上の適切な人物／1つ以上の適切な物体へ何かしらアプローチする 200点
